...
- **Short Description / Subtitle:** Master multiple-choice exams offline with
  custom question banks, timed practice, and detailed performance analytics.
- **Category:** Education / Study Aids
- **Content Rating:** Everyone (PEGI 3 / ESRB Everyone)
- **Keywords:** mcq, exam prep, quiz, test series, offline quiz, question bank,
  flashcards, mock exam, study tracker
...
1. **Data Collection & Sharing:** "No data collected or shared with third
   parties."
2. **Data Security:** "Data is stored strictly on the user's local device
   sandbox."
...
1. **Data Collection:** "Data Not Collected" (The app does not collect any user
   data).
2. **Tracking:** "Not Used for Tracking".
3. **Age Rating Questionnaire:** 4+ (No mature content, no violence, no
   gambling, no user-to-user communications).
